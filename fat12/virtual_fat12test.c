...
int main(int argc, char *argv[]) {
  ...
  if (!find_directory_entry(volume, "/LARGEDIR/FILE66.TXT", &entry)) {
    mktime(&entry.ctime); // Update weekday and day of the year
    printf("  File name    : %s\n", entry.filename);
    printf("  Creation time: %s\n", asctime(&entry.ctime));
    printf("  File size    : %u\n", entry.size);
  ...
  printf("\nAdded Test: Finding file /DIRECT0/DIRECT1/DIRECT2/DIRECT3/DIRECT4/../../../../../DIRECT0/DIRECT1/DIRECT2/DIRECT3/DIRECT4/DEEPFILE.TXT:\n");
  if (!find_directory_entry(volume, "/DIRECT0/DIRECT1/DIRECT2/DIRECT3/DIRECT4/../../../../../DIRECT0/DIRECT1/DIRECT2/DIRECT3/DIRECT4/DEEPFILE.txt", &entry)) {
    mktime(&entry.ctime); // Update weekday and day of the year
    printf("  File name    : %s\n", entry.filename);
    printf("  Creation time: %s\n", asctime(&entry.ctime));
    printf("  File size    : %u\n", entry.size);
  ...
  printf("\nAdded Test: Finding file /:\n");
  if (!find_directory_entry(volume, "/", &entry)) {
    mktime(&entry.ctime); // Update weekday and day of the year
    printf("  File name    : %s\n", entry.filename);
    printf("  Creation time: %s\n", asctime(&entry.ctime));
    printf("  File size    : %u\n", entry.size);
