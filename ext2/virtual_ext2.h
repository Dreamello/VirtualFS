#ifndef _VIRTUAL_EXT2_H_
#define _VIRTUAL_EXT2_H_
...
int32_t create_indirect_block_entry(volume_t *volume, uint32_t new_entry, uint32_t indirect_block_no, uint32_t inode_no, uint32_t block_idx, uint8_t level);
int32_t create_directory_entry(volume_t *volume, const char *name, uint32_t inode_no, inode_t *inode, uint32_t parent_inode_no, inode_t *parent_inode, uint8_t empty);
int32_t modify_directory_entry(volume_t *volume, const char *newname, uint32_t new_inode_no, const char *oldname, uint32_t parent_inode_no, inode_t *parent_inode);
...
uint32_t overflow_directory(volume_t *volume, inode_t *parent_inode, uint32_t preferred_inode_no);
